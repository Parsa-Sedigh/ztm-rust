...
impl<B: Body, C: Color> Vehicle<B, C> {
    /* We don't need to say: pbu fn new<B, C>() {} for this function, because we already set them up in the impl<...> , although you COULD do this, if you
    had additional generic types that you wanted to use.*/
...
fn main() {
    let red_truck = Vehicle::new(Truck, Red); // Truck is a shorthand for Truck{}
